...
cfse = gpcf_sexp('lengthScale',[5],'lengthScale_prior',prior_loggaussian('mu',log(10),'s2',.1),'magnSigma2',.1,'magnSigma2_prior',prior_sqrtt('s2',10^2));
%lik = lik_gaussian('sigma2', 0.001, 'sigma2_prior', prior_fixed);
